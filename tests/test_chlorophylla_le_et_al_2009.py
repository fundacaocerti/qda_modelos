...
class TestChlorophyllaLeEtAl2009:
    def test_expected_result_type(self, setup_bands):
        ...
        le_et_al_2009_result = chlorophylla.le_et_al_2009(
            R20m_bands["B06"], R20m_bands["B05"], R20m_bands["B05"], R20m_bands["B04"]
        )

        assert isinstance(le_et_al_2009_result, numpy.ndarray)
