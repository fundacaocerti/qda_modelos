...
class TestChlorophyllaGowerEtAl2005:
    ...
    def test_expected_result_type(self, setup_bands):
        ...
        gower_et_al_2005_2016_result = chlorophylla.gower_et_al_2005(
            band_6, band_5, band_4, r753_adapted_wavelength, r709_adapted_wavelength, r681_adapted_wavelength)

        assert isinstance(gower_et_al_2005_2016_result,
                          numpy.ndarray)
    ...
    def test_expected_error_for_wrong_number_of_bands(self, setup_bands):
        ...
        with pytest.raises(TypeError):
            chlorophylla.gower_et_al_2005(
                band_5, band_4, r753_adapted_wavelength, r709_adapted_wavelength, r681_adapted_wavelength)
